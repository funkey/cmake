...
macro(find_3rd_party name)
  ...
  elseif(module MATCHES "boost-signals")
    ...
    found_Message("boost-signals" Boost_FOUND is_optional)
    if(Boost_FOUND)
      list(APPEND include_3rd_party ${Boost_INCLUDE_DIR})
      list(APPEND link_3rd_party ${Boost_LIBRARIES})
    endif()
  ...
  elseif(module MATCHES "boost-serialization")
    ...
    found_Message("boost-serialization" Boost_FOUND is_optional)
    if(Boost_FOUND)
      list(APPEND include_3rd_party ${Boost_INCLUDE_DIR})
      list(APPEND link_3rd_party ${Boost_LIBRARIES})
    endif()
  ...
  elseif(module MATCHES "numpy")
    ...
    find_package(NumPy)
    found_Message("numpy" NUMPY_FOUND is_optional)
    if (NUMPY_FOUND)
